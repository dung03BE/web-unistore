...
import { faMagnifyingGlass, faUser, faCartShopping, faLocationDot } from "@fortawesome/free-solid-svg-icons";
import { Menu, MenuItem, IconButton, Badge, Box, AppBar, Toolbar, InputBase } from '@mui/material';
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed">
        <Toolbar>
          ...
          <div className="layout-default_profile">
